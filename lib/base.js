...
//var pick = require('revsci-util/pick');
 ...
 *  next event loop.
 *
 *  The final render step. The props are all full of data now, or an error
 *  has occurred in the data fetch and a props.error String exists.
 *
 *
 *  @param {Object} props Input/Output. The object on which to store the
 *    properties. This object should also contain the options necessary to make
